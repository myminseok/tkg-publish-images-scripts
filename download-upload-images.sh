...
download_upload_image -i projects.registry.vmware.com/tkg/tkg-bom:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tkg-bom --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -i projects.registry.vmware.com/tkg/cluster-api/cluster-api-vsphere-controller:v0.7.10_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/cluster-api/cluster-api-vsphere-controller --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -i projects.registry.vmware.com/tkg/contour:v1.17.1_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/contour --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/envoy:v1.18.3_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/envoy --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -i projects.registry.vmware.com/tkg/cert-manager-controller:v1.1.0_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/cert-manager-controller --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/cert-manager-cainjector:v1.1.0_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/cert-manager-cainjector --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/cert-manager-webhook:v1.1.0_vmware.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/cert-manager-webhook --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -i projects.registry.vmware.com/tkg/tanzu_core/capabilities/capabilities-controller-manager:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tanzu_core/capabilities/capabilities-controller-manager --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/tanzu_core/provider/provider-templates:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tanzu_core/provider/provider-templates --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/tanzu_core/tkr/tkr-controller-manager:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tanzu_core/tkr/tkr-controller-manager --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -i projects.registry.vmware.com/tkg/tkg-bom:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tkg-bom --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -b projects.registry.vmware.com/tkg/packages/standard/cert-manager:v1.1.0_vmware.1-tkg.2 --to-repo infra-harbor.lab.pcfdemo.net/tkg/packages/standard/cert-manager --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -b projects.registry.vmware.com/tkg/packages/standard/contour:v1.17.1_vmware.1-tkg.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/packages/standard/contour --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -b projects.registry.vmware.com/tkg/packages/standard/harbor:v2.2.3_vmware.1-tkg.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/packages/standard/harbor --registry-ca-cert-path /tmp/cacrtbase64d.crt

download_upload_image -b projects.registry.vmware.com/tkg/packages/standard/multus-cni:v3.7.1_vmware.1-tkg.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/packages/standard/multus-cni --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -b projects.registry.vmware.com/tkg/packages/standard/repo:v1.4.0 --to-repo infra-harbor.lab.pcfdemo.net/tkg/packages/standard/repo --registry-ca-cert-path /tmp/cacrtbase64d.crt
...
download_upload_image -i projects.registry.vmware.com/tkg/tkg-bom:v1.4.0-fips.1 --to-repo infra-harbor.lab.pcfdemo.net/tkg/tkg-bom --registry-ca-cert-path /tmp/cacrtbase64d.crt
